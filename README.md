...
| 游戏部署 | 5 个内置游戏模板（Palworld/Minecraft Java+Bedrock/Valheim/Terraria），点击卡片直接部署，SteamCMD 实时安装进度，部署完成自动创建实例 |
...
| 插件 | 扫描 data/plugins/*/plugin.json，本地插件市场，一键安装，创建/删除/启用禁用，配置读写，目录名安全校验 |
